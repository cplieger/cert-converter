...
//
// reapDeferral is ten seconds of real time on every sync-mode reap, so leaving the
...
// directly in TestWaitBeforeReap. Tests that need to observe the wait (count it, or
